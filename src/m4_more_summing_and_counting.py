...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 3
    answer = count_cosines_from(2, 7, 0.25)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 4
    answer = count_cosines_from(5, 10, -0.33)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(2, 9, 0.75)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 7
    answer = count_cosines_from(1, 15, 0.10)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.592857143  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 7)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.8456349206  # This is APPROXIMATELY the correct answer.
